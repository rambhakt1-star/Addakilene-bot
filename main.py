...
photologo = 'https://ar-hosting.pages.dev/1751519809887.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://ar-hosting.pages.dev/1751519809887.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://ar-hosting.pages.dev/1751519809887.jpg'
photozip = 'https://ar-hosting.pages.dev/1751519809887.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/BotChatAll")        ],
    ]
)
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("💫 Get Access", url="https://t.me/Contact_AdminSbot")]
                    ])
                )
                return
            ...
            await m.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📚 Help", url="https://t.me/BotChatAll")]])
            )
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        ...
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/Contact_AdminSbot")
        ]])
    )
